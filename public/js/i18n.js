...
const TRANSLATIONS = {
  en: {
    ...
    gamepad_config_title: "Configure gamepad",
    gamepad_panel_title: "🎮 Configure gamepad",
    gamepad_not_connected: "No gamepad detected. Press any button on it to activate.",
    gamepad_connected: "Connected: {name}",
    gamepad_reset: "Reset to defaults",
    gamepad_save: "Save configuration",
    gamepad_close: "Close",
    gamepad_saved: "Configuration saved for this game.",
    gamepad_remap: "Remap",
    gamepad_waiting_input: "Press a button...",
    gamepad_waiting_key_input: "Press a key...",
    gamepad_button_col: "Button",
    gamepad_key_col: "Sends key",
    gamepad_button_label: "Button {index}",
    gamepad_action_up: "⬆️ Up",
    gamepad_action_down: "⬇️ Down",
    gamepad_action_left: "⬅️ Left",
    gamepad_action_right: "➡️ Right",
    gamepad_action_a: "🅰️ A",
    gamepad_action_b: "🅱️ B",
    gamepad_action_start: "▶️ Start",
    profile_title: "Profile (syncs saves across devices)",
    profile_none: "No profile",
    profile_new: "+ New profile...",
    prompt_profile_name: "Your name:",
    error_creating_profile: "Error creating profile.",
    save_synced: "Save synced",
    save_sync_error: "Could not sync save to server",
    ...
    renderer_toggle_label: "Needs WebGL",
    renderer_toggle_hint: "Turn on if the game shows a blank/black screen with this off (e.g. games using BitmapData.draw()). Trade-off: in-game cover capture may not work for this title.",
    description_placeholder: "Description",
    error_saving_game_info: "Error saving game info.",
    flashpoint_heading: "Import from Flashpoint Archive",
    flashpoint_note: 'Searches <a href="https://flashpointarchive.org" target="_blank" rel="noopener">flashpointarchive.org</a> and imports the game only if one of its original hosting links still serves a real .swf file. Nothing is downloaded from Flashpoint\'s own mirrors.',
    label_flashpoint_query: "Game name",
    flashpoint_search_btn: "Search",
    flashpoint_import_btn: "Import",
    flashpoint_importing: "Importing...",
    flashpoint_imported: "Imported!",
    flashpoint_imported_with_assets: "Imported! (+{count} extra file(s) found)",
    flashpoint_no_results: "No results found.",
    error_searching_flashpoint: "Error searching Flashpoint Archive.",
    network_error_searching_flashpoint: "Network error searching Flashpoint Archive.",
    error_importing_flashpoint: "Error importing this game.",
    network_error_importing_flashpoint: "Network error importing this game.",
    err_query_required: "Type a game name to search for.",
    err_id_required: "Missing Flashpoint entry ID.",
    err_too_many_requests: "Please wait a moment before trying again.",
    err_flashpoint_unreachable: "Couldn't reach Flashpoint Archive. Try again later.",
    err_not_a_flash_game: "This entry isn't a Flash game.",
    err_no_working_swf_found: "None of this game's original links are still online. Skipped.",
  ...
  pt: {
    ...
    gamepad_config_title: "Configurar controle",
    gamepad_panel_title: "🎮 Configurar controle",
    gamepad_not_connected: "Nenhum controle detectado. Aperte qualquer botão nele pra ativar.",
    gamepad_connected: "Conectado: {name}",
    gamepad_reset: "Restaurar padrão",
    gamepad_save: "Salvar configuração",
    gamepad_close: "Fechar",
    gamepad_saved: "Configuração salva pra este jogo.",
    gamepad_remap: "Remapear",
    gamepad_waiting_input: "Aperte um botão...",
    gamepad_waiting_key_input: "Aperte uma tecla...",
    gamepad_button_col: "Botão",
    gamepad_key_col: "Envia tecla",
    gamepad_button_label: "Botão {index}",
    gamepad_action_up: "⬆️ Cima",
    gamepad_action_down: "⬇️ Baixo",
    gamepad_action_left: "⬅️ Esquerda",
    gamepad_action_right: "➡️ Direita",
    gamepad_action_a: "🅰️ A",
    gamepad_action_b: "🅱️ B",
    gamepad_action_start: "▶️ Start",
    profile_title: "Perfil (sincroniza saves entre aparelhos)",
    profile_none: "Sem perfil",
    profile_new: "+ Novo perfil...",
    prompt_profile_name: "Seu nome:",
    error_creating_profile: "Erro ao criar perfil.",
    save_synced: "Save sincronizado",
    save_sync_error: "Não foi possível sincronizar o save com o servidor",
    ...
    renderer_toggle_label: "Precisa de WebGL",
    renderer_toggle_hint: "Ative se o jogo aparecer com a tela em branco/preta sem isso (ex: jogos que usam BitmapData.draw()). Compensação: a captura de capa in-game pode não funcionar pra esse jogo.",
    ...
    flashpoint_note: 'Busca em <a href="https://flashpointarchive.org" target="_blank" rel="noopener">flashpointarchive.org</a> e só importa o jogo se algum dos links originais de hospedagem ainda servir um .swf de verdade. Nada é baixado dos espelhos do próprio Flashpoint.',
    label_flashpoint_query: "Nome do jogo",
    flashpoint_search_btn: "Buscar",
    flashpoint_import_btn: "Importar",
    flashpoint_importing: "Importando...",
    flashpoint_imported: "Importado!",
    flashpoint_imported_with_assets: "Importado! (+{count} arquivo(s) extra encontrado(s))",
    flashpoint_no_results: "Nenhum resultado encontrado.",
    error_searching_flashpoint: "Erro ao buscar no Flashpoint Archive.",
    network_error_searching_flashpoint: "Erro de rede ao buscar no Flashpoint Archive.",
    error_importing_flashpoint: "Erro ao importar este jogo.",
    network_error_importing_flashpoint: "Erro de rede ao importar este jogo.",
    err_query_required: "Digite o nome de um jogo pra buscar.",
    err_id_required: "ID do Flashpoint ausente.",
    err_too_many_requests: "Espere um instante antes de tentar de novo.",
    err_flashpoint_unreachable: "Não foi possível acessar o Flashpoint Archive. Tente novamente mais tarde.",
    err_not_a_flash_game: "Este item não é um jogo em Flash.",
    err_no_working_swf_found: "Nenhum dos links originais deste jogo ainda está no ar. Pulado.",
