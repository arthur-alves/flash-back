...
const TRANSLATIONS = {
  en: {
    ...
    flashpoint_note: "Searches flashpointarchive.org and imports the game only if one of its original hosting links still serves a real .swf file. Nothing is downloaded from Flashpoint's own mirrors.",
  ...
  pt: {
    ...
    flashpoint_note: "Busca em flashpointarchive.org e só importa o jogo se algum dos links originais de hospedagem ainda servir um .swf de verdade. Nada é baixado dos espelhos do próprio Flashpoint.",
